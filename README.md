...
A web-based life point tracker for Magic: The Gathering, inspired by the awesome [Lifetap](https://play.google.com/store/apps/details?id=com.lifetap) application.

▶️ [Here it is](https://naereen.github.io/My-Android-app-to-track-life-points-at-Magic-the-Gathering/)! ◀️

It is built with a awesome and recent web front-end stack: [SvelteKit](https://svelte.dev/docs/kit/introduction), [TypeScript](https://www.typescriptlang.org/), and [Tailwind CSS](https://tailwindcss.com/). I've learned a lot, in the last few months, thanks to this project!
