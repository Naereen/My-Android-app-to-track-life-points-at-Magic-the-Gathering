<script lang="ts">
	...
	// Allow passing additional CSS classes for effects like gradients or foils
	export let extraEffects: string = '';
	// Allow passing additional CSS for rotation or other transformations
