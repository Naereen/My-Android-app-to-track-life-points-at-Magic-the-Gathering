...
### The +2/-2 bug : still NOT fixed!

- [ ] On mobile (on my tablet) right now, when doing a very short touch (click) on the +1/-1 buttons, it sometimes adds/subtracts 2 points at once instead of 1 point at a time.
- [ ] It seems it's like a riddle to solve: if I fix that, the web-desktop view doesn't work, and the opposite holds also.
